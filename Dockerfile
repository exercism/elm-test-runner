# node:24.18.0-alpine, alpine version 3.24.1
...
# Install elm-test-rs
RUN curl -L -o elm-test-rs_linux.tar.gz https://github.com/mpizenberg/elm-test-rs/releases/download/v3.0.2/elm-test-rs_linux.tar.gz \
